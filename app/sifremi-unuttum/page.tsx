...
export default function ForgotPasswordPage() {
  const [state, formAction, isPending] = useActionState(forgotPasswordAction as any, initialState);
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="card-surface rounded-2xl p-8 relative z-10 glow-cyan">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-black text-white tracking-widest">ŞİFREMİ UNUTTUM</h1>
            <p className="text-sm text-gray-400 mt-2">
              E-posta adresini gir. Şifreni yenilemen için güvenli bir bağlantı gönderelim.
            </p>
          </div>
          ...
          {state?.success ? (
            ...
            <form action={formAction} className="space-y-4">
              ...
              >
                {isPending ? 'GÖNDERİLİYOR...' : 'ŞİFRE SIFIRLAMA BAĞLANTISI GÖNDER'}
              </button>
            </form>
          )}
